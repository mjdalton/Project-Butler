...
?>
		...
		<center>
			<h3>Question 1</h3><br>
			<a href = "Exam1Pages/Q1.php"><img src="Exam1/Q1.png" alt="Question 1" class="imgLink"></a><br><br>
			<?php
			...
			?><br><br>
			<h3>Question 2</h3><br>
			<a href = "Exam1Pages/Q2.php"><img src="Exam1/Q2.png" alt="Question 2" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q2';
			$test = 'exam1';
			...
			//display solution if question is answered
			if($pos !== false){
				echo '<a href="Exam1/Solutions/Q2s.PNG"><button class="submitBtn">Solution</button></a>';
			}
		
			
			?><br><br>
			<h3>Question 3</h3><br>
			<a href = "Exam1Pages/Q3.php"><img src="Exam1/Q3.png" alt="Question 3" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q3';
			$test = 'exam1';
			...
			?><br><br>
			<h3>Question 4</h3><br>
			<a href = "Exam1Pages/Q4.php"><img src="Exam1/Q4.png" alt="Question 4" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q4';
			$test = 'exam1';
			...
			?><br><br>
			<h3>Question 5</h3><br>
			<a href = "Exam1Pages/Q5.php"><img src="Exam1/Q5.png" alt="Question 5" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q5';
			$test = 'exam1';
