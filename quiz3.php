...
?>
		...
		<center>
			<h3>Question 1</h3><br>
			<a href = "Quiz3Pages/Q1.php"><img src="Quiz3/Q1.png" alt="Question 1" class="imgLink"></a><br><br>
			<?php
			...
			?><br><br>
			<h3>Question 2</h3><br>
			<a href = "Quiz3Pages/Q2.php"><img src="Quiz3/Q2.png" alt="Question 2" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q2';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 3</h3><br>
			<a href = "Quiz3Pages/Q3.php"><img src="Quiz3/Q3.png" alt="Question 3" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q3';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 4</h3><br>
			<a href = "Quiz3Pages/Q4.php"><img src="Quiz3/Q4.png" alt="Question 4" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q4';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 5</h3><br>
			<a href = "Quiz3Pages/Q5.php"><img src="Quiz3/Q5.png" alt="Question 5" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q5';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 6</h3><br>
			<a href = "Quiz3Pages/Q6.php"><img src="Quiz3/Q6.png" alt="Question 6" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q6';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 7</h3><br>
			<a href = "Quiz3Pages/Q7.php"><img src="Quiz3/Q7.png" alt="Question 7" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q7';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 8</h3><br>
			<a href = "Quiz3Pages/Q8.php"><img src="Quiz3/Q8.png" alt="Question 8" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q8';
			$test = 'quiz3';
			...
			?><br><br>
			<h3>Question 9</h3><br>
			<a href = "Quiz3Pages/Q9.php"><img src="Quiz3/Q9.png" alt="Question 9" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q9';
			$test = 'quiz3';
			...
			<a href = "Quiz3Pages/Q10.php"><img src="Quiz3/Q10.png" alt="Question 10" class="imgLink"></a><br><br>
			<?php
			//search to see if question number is answered
			$qnum = 'Q10';
			$test = 'quiz3';
