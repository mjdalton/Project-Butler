...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['exam3q1'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['exam3q1'] == 2){
		...
		<br><br><br>
		<!--Question prompt-->
		<center><img src="../Exam3/Q1.png" alt="Question 1" class="img"><br><br><br><br><br>
		...
		<!--Nav buttons-->
		<a href="../exam3.php"><button class="submitBtn"><- All Questions</button></a>
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['exam3q1'] = 1;
				if($_SESSION['exam3q1refresh'] == 1){
					$_SESSION['exam3q1refresh'] = 0;
					header("Refresh:0");
				}
			}
