...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['quiz1q2'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['quiz1q2'] == 2){
		...
		<!-- prompt question -->
		<center><img src="../Quiz1/Q2.png" alt="Question 2" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['quiz1q2'] = 1;
				if($_SESSION['quiz1q2refresh'] == 1){
					$_SESSION['quiz1q2refresh'] = 0;
					header("Refresh:0");
				}
			}
