...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['exam3q3'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['exam3q3'] == 2){
		...
		<br><br><br>
		<!--Question prompt-->
		<center><img src="../Exam3/Q3.png" alt="Question 3" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['exam3q3'] = 1;
				if($_SESSION['exam3q3refresh'] == 1){
					$_SESSION['exam3q3refresh'] = 0;
					header("Refresh:0");
				}
			}
