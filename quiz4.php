    ...
    <head>
		<!-- <style>
			@font-face {
				...
				src: url(luckiest_guy.ttf);
			}
			div {
				font-family: luckiest_guy;
			}
		</style> -->
      <title>265 Quiz 4</title>
	  ...
	  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		...
		<script src="fallingstar.js" type="text/javascript"></script>
  </head>
  <body>
	  ...
	  <header>
		<h1>Math 265</h1>
			<nav>
				<ul>
					<!--
					<li><a href="#education">Quiz 1</a></li>
					<li><a href="#work_experience">Quiz 2</a></li>
					<li><a href="#projects">Quiz 3</a></li>
					-->
					<li><a href="#interests">Midterm 1</a></li>
		...
		<p>I'm thinking of also adding a drop down menu from the top menu bar that includes a list of links to all quizzes<br>The footer should stick to the bottom after we 
			...
			pick different colors, just maybe similar shades of light/dark to this?</p><br>
		<!--
		<form>
		...
		<footer>
			...
			<div class="icon">
			<center>
				<a href="https://www.linkedin.com/in/margaret-dalton-3297a7114/"><i class="fa fa-linkedin-square" style=" color: #0E0B16;"></i></a>
				<a href="https://github.com/mjdalton"><i class="fa fa-github-square" style=" color: #0E0B16;"></i></a>
			</center>
			</div>
			<br>
		</footer>
