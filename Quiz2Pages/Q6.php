...
?>		
		...
		<br><br><br>
		<!-- prompt question -->
		<center><img src="../Quiz2/Q6.png" alt="Question 6" class="img"><br><br><br><br><br>
		<p>Input your answer here:</p>
		<form action="checker/Q6c.php" method="POST">
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['quiz2q6'] = 1;
				if($_SESSION['quiz2q6refresh'] == 1){
					$_SESSION['quiz2q6refresh'] = 0;
					header("Refresh:0");
				}
			}
