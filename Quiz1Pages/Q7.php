...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['quiz1q7'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['quiz1q7'] == 2){
		...
		<br><br><br>
		<!-- prompt question -->
		<center><img src="../Quiz1/Q7.png" alt="Question 7" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['quiz1q8'] = 1;
				if($_SESSION['quiz1q8refresh'] == 1){
					$_SESSION['quiz1q8refresh'] = 0;
					header("Refresh:0");
				}
			}
