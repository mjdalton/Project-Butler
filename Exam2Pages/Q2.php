...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['exam2q2'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['exam2q2'] == 2){
		...
		<br><br><br>
		<!--Question prompt-->
		<center><img src="../Exam2/Q2.png" alt="Question 2" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['exam2q2'] = 1;
				if($_SESSION['exam2q2refresh'] == 1){
					$_SESSION['exam2q2refresh'] = 0;
					header("Refresh:0");
				}
			}
