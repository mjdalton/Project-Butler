...
?>
		...
		<center><a href="quiz3.php"><button class="resumeBtn">
		 <span class="title">QUIZ 3</span>
   		...
   		<center><a href="exam1.php"><button class="resumeBtn">
		 <span class="title">Exam 1</span>
   		 <span style = "font-size: 25px" class="comment"> Exam  1 </span>
   		</button></a></center>
   		<center><a href="exam2.php"><button class="resumeBtn">
		 <span class="title">Exam 2</span>
   		 <span style = "font-size: 25px" class="comment"> Exam  2 </span>
   		</button></a></center>
   		<center><a href="exam3.php"><button class="resumeBtn">
		 <span class="title">Exam 3</span>
   		 <span style = "font-size: 25px" class="comment"> Exam  3 </span>
   		</button></a></center>
