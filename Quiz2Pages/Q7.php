...
?>		
		...
		<br><br><br>
		<!-- prompt question -->
		<center><img src="../Quiz2/Q7.png" alt="Question 7" class="img"><br><br><br><br><br>
		<p>Input your answer here:</p>
		<form action="checker/Q7c.php" method="POST">
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['quiz2q7'] = 1;
				if($_SESSION['quiz2q7refresh'] == 1){
					$_SESSION['quiz2q7refresh'] = 0;
					header("Refresh:0");
				}
			}
