...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['quiz3q10'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['quiz3q10'] == 2){
		...
		<br><br><br>
		<!-- prompt question -->
		<center><img src="../Quiz3/Q10.png" alt="Question 10" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['quiz3q10'] = 1;
				if($_SESSION['quiz3q10refresh'] == 1){
					$_SESSION['quiz3q10refresh'] = 0;
					header("Refresh:0");
				}
			}
