...
?>		
		<?php
			if (!isset($_SESSION['u_id'])) {
				...
				if($_SESSION['exam2q5'] == 1){
					echo '<br><br><h4>That is correct!</h4>';
				}
				else if($_SESSION['exam2q5'] == 2){
		...
		<!--Question prompt-->
		<center><img src="../Exam2/Q5.png" alt="Question 5" class="img"><br><br><br><br><br>
		...
		<?php
			...
			if($pos !== false){
				...
				$_SESSION['exam2q5'] = 1;
				if($_SESSION['exam2q5refresh'] == 1){
					$_SESSION['exam2q5refresh'] = 0;
					header("Refresh:0");
				}
			}
